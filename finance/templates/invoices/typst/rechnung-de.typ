// =============================================================================
// BLAUWEISS-EDV LLC – Rechnungstemplate (Deutsch, EU-Kunden)
// =============================================================================
// Verwendung: Variablen oben anpassen, dann `typst compile rechnung.typ`
// Reverse Charge nach Art. 196 MwStSystRL (Richtlinie 2006/112/EG)
// =============================================================================

// === RECHNUNGSDATEN (hier anpassen) ===
#let rechnung_nr = "OP_AR001_2025"
#let datum = "19. Dezember 2025"
...
#let kunde_ust_id = "DE310161615"  // USt-IdNr. des Kunden (Pflicht bei Reverse Charge)

// Positionen: (Beschreibung, Menge, Einheit, Einzelpreis)
#let positionen = (
  ("Beratungsleistung remote", 184.00, "Ph", 105.00),
  ("Beratungsleistung on-site", 0.00, "Ph", 120.00),
)

// Zahlungshinweis
#let skonto_text = "3% Skonto bei Sofortzahlung (1-2 Tage)"

// === FIRMENDATEN (normalerweise fix) ===
...
#let firma_ein = "XX-XXXXXXX"  // EIN der LLC (noch zu beantragen)

// Bankverbindung (treuhänderisch bis US-Konto eröffnet)
